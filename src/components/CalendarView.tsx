                     ...
                     if ((payload as any).patientEmail) {
                         await fetch('/api/emails/anamnese', {
                             ...
                             body: JSON.stringify({ 
                                ...
                                link: `${window.location.origin}/portal-paciente/login?t=${btoa((payload as any).patientEmail)}`,
                                      ...
                                      try {
                                         ...
                                         const emailRes = await fetch('/api/emails/anamnese', {
                                            ...
                                            body: JSON.stringify({
                                               ...
                                               time: selectedAppointment.time,
                                               link: `${window.location.origin}/portal-paciente/login?t=${btoa(selectedAppointment.patientEmail)}`
                                            })
                                         });
